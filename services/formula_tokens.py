...
RAW_FIELDS = [
    "OPEN", "HIGH", "LOW", "CLOSE", "PDH", "PDL", "PCLOSE",
...
BUILTIN_FORMULAS = {
    ...
    'DT': {'name': 'DAY TOP', 'tokens': [{'type': 'func', 'value': 'MAX_OF(', 'field': 'PCLOSE', 'window': 'LAST_5_TRADING_DAYS'}], 'description': 'DAY TOP IS THE MAXIMUM CLOSE OF LAST 5 DAYS CLOSE', 'frequency': 'DAILY'},
    'DB': {'name': 'DAY BOTTOM', 'tokens': [{'type': 'func', 'value': 'MIN_OF(', 'field': 'PCLOSE', 'window': 'LAST_5_TRADING_DAYS'}], 'description': 'DAY BOTTOM  IS THE MINIMUM CLOSE OF LAST 5 DAYS CLOSE', 'frequency': 'DAILY'},
    ...
    'DR3': {'name': 'DAILY R3', 'tokens': [{'type': 'field', 'value': 'PCLOSE'}, {'type': 'op', 'value': '+'}, {'type': 'paren', 'value': '('}, {'type': 'field', 'value': 'PDH'}, {'type': 'op', 'value': '-'}, {'type': 'field', 'value': 'PDL'}, {'type': 'paren', 'value': ')'}, {'type': 'op', 'value': '*'}, {'type': 'num', 'value': '1.1'}, {'type': 'op', 'value': '/'}, {'type': 'num', 'value': '4'}], 'description': 'DAILY R3 IS CALCULATED EVERY DAY USING PREVIOUS DAY CLOSE,PREVIOUS DAY HIGH AND PREVIOUS DAY LOW', 'frequency': 'DAILY'},
    'DR4': {'name': 'DAILY R4', 'tokens': [{'type': 'field', 'value': 'PCLOSE'}, {'type': 'op', 'value': '+'}, {'type': 'paren', 'value': '('}, {'type': 'field', 'value': 'PDH'}, {'type': 'op', 'value': '-'}, {'type': 'field', 'value': 'PDL'}, {'type': 'paren', 'value': ')'}, {'type': 'op', 'value': '*'}, {'type': 'num', 'value': '1.1'}, {'type': 'op', 'value': '/'}, {'type': 'num', 'value': '2'}], 'description': 'DAILY R4 IS CALCULATED EVERY DAY USING PREVIOUS DAY CLOSE,PREVIOUS DAY HIGH AND PREVIOUS DAY LOW', 'frequency': 'DAILY'},
    'DR6': {'name': 'DAILY R6', 'tokens': [{'type': 'paren', 'value': '('}, {'type': 'field', 'value': 'PDH'}, {'type': 'op', 'value': '/'}, {'type': 'field', 'value': 'PDL'}, {'type': 'paren', 'value': ')'}, {'type': 'op', 'value': '*'}, {'type': 'field', 'value': 'PCLOSE'}], 'description': 'DAILY R6 IS CALCULATED EVERY DAY USING PREVIOUS DAY CLOSE,PREVIOUS DAY HIGH AND PREVIOUS DAY LOW', 'frequency': 'DAILY'},
    'DS3': {'name': 'DAILY S3', 'tokens': [{'type': 'field', 'value': 'PCLOSE'}, {'type': 'op', 'value': '-'}, {'type': 'paren', 'value': '('}, {'type': 'field', 'value': 'PDH'}, {'type': 'op', 'value': '-'}, {'type': 'field', 'value': 'PDL'}, {'type': 'paren', 'value': ')'}, {'type': 'op', 'value': '*'}, {'type': 'num', 'value': '1.1'}, {'type': 'op', 'value': '/'}, {'type': 'num', 'value': '4'}], 'description': 'DAILY S3 IS CALCULATED EVERY DAY USING PREVIOUS DAY CLOSE,PREVIOUS DAY HIGH AND PREVIOUS DAY LOW', 'frequency': 'DAILY'},
    'DS4': {'name': 'DAILY S4', 'tokens': [{'type': 'field', 'value': 'PCLOSE'}, {'type': 'op', 'value': '-'}, {'type': 'paren', 'value': '('}, {'type': 'field', 'value': 'PDH'}, {'type': 'op', 'value': '-'}, {'type': 'field', 'value': 'PDL'}, {'type': 'paren', 'value': ')'}, {'type': 'op', 'value': '*'}, {'type': 'num', 'value': '1.1'}, {'type': 'op', 'value': '/'}, {'type': 'num', 'value': '2'}], 'description': 'DAILY S6 IS CALCULATED EVERY DAY USING PREVIOUS DAY CLOSE,PREVIOUS DAY HIGH AND PREVIOUS DAY LOW', 'frequency': 'DAILY'},
    'DS6': {'name': 'DAILY S6', 'tokens': [{'type': 'field', 'value': 'PCLOSE'}, {'type': 'op', 'value': '-'}, {'type': 'paren', 'value': '('}, {'type': 'field', 'value': 'DR6'}, {'type': 'op', 'value': '-'}, {'type': 'field', 'value': 'PCLOSE'}, {'type': 'paren', 'value': ')'}], 'description': 'DAILY S4 IS CALCULATED EVERY DAY USING PREVIOUS DAY CLOSE,PREVIOUS DAY HIGH AND PREVIOUS DAY LOW', 'frequency': 'DAILY'},
    ...
    'DAY PIVOT': {'name': 'DAY PIVOT', 'tokens': [{'type': 'paren', 'value': '('}, {'type': 'field', 'value': 'PDH'}, {'type': 'op', 'value': '+'}, {'type': 'field', 'value': 'PDL'}, {'type': 'op', 'value': '+'}, {'type': 'field', 'value': 'PCLOSE'}, {'type': 'paren', 'value': ')'}, {'type': 'op', 'value': '/'}, {'type': 'num', 'value': '3'}], 'description': '', 'frequency': 'DAILY'},
